...
function draw() {
  background(0);
  mostraNomeDoJogo(xNameGame, yNameGame);
  mostraBolinha();
  movimentaBolinha();
  ...
  mostraNomeDoJogo(mostraNomeDoJogo, 300, 25);
  incluiPlacar(meusPontos, 150, 30);
  incluiPlacar(pontosOponente, 450, 30);
  marcaPonto();
}

function mostraNomeDoJogo() {
  stroke(255);
  textAlign(CENTER);
  textSize(16);
  text(nameGame, xNameGame, yNameGame);
  print("O nome do jogo é: " + nameGame);
}
